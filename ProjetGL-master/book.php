...
<li>
<li>
<input type="checkbox" name="terms" value="terms"> J'accepte lesterms et les  conditions de votre site.<br>
</li>
...
<?php
	...
	echo"S'il te plait choisit le nombre de passenger while searching the flight.&nbsp;&nbsp;&nbsp;"; 
