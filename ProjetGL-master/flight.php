...
<div id="flights">
						...
						<label for="radio2">Une destination</label>
						<div>
					
							<select id="cmbMake" name="Make"     onchange="document.getElementById('selected_text').value=this.options[this.selectedIndex].text">
									<option value="0" disabled="disabled" selected="selected" id="place">Depart de...</option>
						...
						<p><label style="display:block" id="label1">Returner date:</label>
						...
						<div>
							...
							<select id="cmbMake" name="children" onchange="document.getElementById('selected_text3').value=this.options[this.selectedIndex].text">
										<option value="0" disabled="disabled" selected="selected" id="place1">Enfant</option>
										<option value="1">1</option>
